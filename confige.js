...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY Queen_FAITH-MD 🤍*",
...
BOT_NAME: process.env.BOT_NAME || "Queen_FAITH-MD",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "Queen_FAITH-MD",
...
OWNER_NAME: process.env.OWNER_NAME || "Queen_FAITH-MD",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Queen_FAITH-MD V5*",
// add bot owner name    
...
LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *Queen_FAITH-MD V5*⚡",
// add alive msg here 
